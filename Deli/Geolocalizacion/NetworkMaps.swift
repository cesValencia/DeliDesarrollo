...
protocol URL_SessionDelegate2 {
    func connectionFinishSuccessfull(session: URL_Session2, response: [NSDictionary]) //Response del mismotipo que devuelve el JSON o utilizar any para cachar cualquiera de los 2
    func connectionFinishWithError(session: URL_Session2, error: Error)
}

class URL_Session2: NSObject, URLSessionDelegate, URLSessionDataDelegate {
    ...
    var delegate: URL_SessionDelegate2?
