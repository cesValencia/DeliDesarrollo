...
class ControllerT1: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UIScrollViewDelegate {
            ...
            do{
                ...
                if json.count > 0{ //numero de post en el json
                    ...
                    for obj in json{ //Recorrido de todos los post en el json
                        ...
                        if restaurante.tag.lowercased() == "carnes" {
                            self.dataSource.append(restaurante)
                        }
